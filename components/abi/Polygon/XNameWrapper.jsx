export const XNameWrapper_ABI = [
 ...
 {
  inputs: [
   { internalType: "contract INameWrapperUpgrade", name: "_upgradeAddress", type: "address" },
  ],
 ...
 },
 {
  inputs: [
   { internalType: "bytes", name: "_name", type: "bytes" },
   { internalType: "address", name: "_wrappedOwner", type: "address" },
